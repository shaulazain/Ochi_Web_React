...
const Footer = () => {
  return (
    <div  className=' flex gap-5w-full h-screen  p-20 bg-zinc-900'>
        <div className='w-1/2 h-full flex flex-col justify-between'>
            <div className="heading ">
            <h1 className='text-[7vw] font-semibold leading-none uppercase -mb-5'>Eye-</h1>
            <h1 className='text-[7vw] font-semibold leading-none uppercase -mb-5' >Opening</h1>
            </div>
        ...
        <div className='w-1/2 '>
        <h1 className='text-[5vw] font-semibold leading-none uppercase -mb-5'>presentations
        </h1>
        <div className='dets mt-20'>

         {["Facebook", "Instagram", "Linkdin"].map((item,index)=>{
           return(
           <a className='block text-xl font-light underline mb-2  ' href="#">{item}</a>
            )
          })}
         </div>
